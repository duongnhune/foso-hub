...
export const Video = Node.create({
  ...
  addAttributes() {
    return {
      ...
      class: {
        ...
        parseHTML: (el) => (el as HTMLVideoElement).getAttribute("class"),
    ...
    return [
      {
        ...
        getAttrs: (el) => ({
          ...
          class: (el as HTMLVideoElement).getAttribute("class"),
        }),
      },
    ];
  },
  ...
  renderHTML({ HTMLAttributes }) {
    return [
      "video",
      { controls: "true", style: "width: 70%; margin: 0 15%;", ...HTMLAttributes },
      ...
      setVideo:
        ...
        ({ commands }) =>
          commands.insertContent(
            `<video controls="true" style="width: 70%; margin: 0 15%;" class="lesson-video" src="${src}" />`
          ),
